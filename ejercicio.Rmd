...
colnames(predic0) <- c("fid", "MAC_CAL_F_0", "MAC_CAL_F_0")
predic1 <- multGLM.MAC_CAL1$predictions
colnames(predic1) <- c("fid", "MAC_CAL_F_1", "MAC_CAL_F_1")
predic2 <- multGLM.MAC_CAL2$predictions
colnames(predic2) <- c("fid", "MAC_CAL_F_2", "MAC_CAL_F_2")
predic3 <- multGLM.MAC_CAL3$predictions
colnames(predic3) <- c("fid", "MAC_CAL_F_3", "MAC_CAL_F_3")
